...
venn.list$True <- na.omit(table[table$status == 1, "gene_id"])
...
for(j in names(methodsList)){
  ...
  # plotVenn(venn.list, venn.colors = venn.colors, venn.subset = c(methods, "True"), margin = 0.1, cat.cex=1.8, cex=1.7, plotPath = plotPath)
