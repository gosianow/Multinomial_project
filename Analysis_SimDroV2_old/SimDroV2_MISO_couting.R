...
miso.index <- "/home/Shared/data/annotation/Drosophila/Ensembl70/miso_0.4.9_index"
...
cmd.p <- paste0(miso.path, "run_events_analysis.py --compute-genes-psi ", miso.index, " /home/Shared/tmp/Simulation/simulation_drosophila_V2/sam/sim_samp", metadata$SampleName1, "_s.bam --output-dir MISOCounts/miso_samp", metadata$SampleName1, " --read-len ", 75," -p 10 --paired-end 200 25 " ,"\n") 
cat(cmd.p)
