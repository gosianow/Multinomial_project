#######################################################
# g2 DM methods based on dirmult package 
# created 22 July 2014 

# update 25 July 2014
# + return null when error in dirmult 
# update 30 July 2014
# + return null when rowSums equal 0
...
dirmult <- function(data,init,initscalar,epsilon=10^(-4),trace=TRUE,mode){
  ...
  list(loglik=lik1,ite=ite-1,gamma=as.numeric(gamma),pi=pi,theta=theta, mom=mom) ## CHANGE!
}
